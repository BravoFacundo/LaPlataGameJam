...
public class OLDPlayerMovement : MonoBehaviour
{
    ...
    private void InputHandling()
    {
        ...
        if (Input.GetKey(growKey) && size < 3 && canChange) SizeHandling(size);
        if (Input.GetKey(shrinkKey) && size > 1 && canChange) SizeHandling(size);
    ...
    private void SizeHandling(int sizeState)
    {
